...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("muteall")
    .setDescription(
      "Mutea a todos los miembros en un canal de voz, excepto el rol de STAFF"
    )
  ...
  async execute(interaction) {
    ...
    if (!staffRole) {
      return interaction.reply(
        "El rol de hablantes no se encontró en el servidor."
      );
    }
    ...
    return interaction.reply(
      `Muteados todos los miembros en el canal de voz "${voiceChannel.name}", excepto el rol de hablantes.`
    );
  },
};
