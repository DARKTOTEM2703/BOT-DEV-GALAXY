...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("desmutear")
    .setDescription(
      "Desmutea a todos los miembros en un canal de voz, excepto el rol de Staff"
    )
  ...
  async execute(interaction) {
    ...
    if (!staffRole) {
      return interaction.reply(
        "El rol de Staff no se encontró en el servidor."
      );
    }
    ...
    return interaction.reply(
      `Desmuteados todos los miembros en el canal de voz "${voiceChannel.name}", excepto el rol de Staff.`
    );
  },
};
